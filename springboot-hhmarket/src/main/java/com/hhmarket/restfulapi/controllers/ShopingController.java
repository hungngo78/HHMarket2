...
public class ShopingController {
	...
	@DeleteMapping(path= "/remove_from_shopping_cart/{cartDetailsId}", produces = "application/json")
	public ResponseEntity<Object> remove_from_shopping_cart(@PathVariable int cartDetailsId) {
		try {
			int res = shopingService.removeFromShoppingCart(cartDetailsId);
